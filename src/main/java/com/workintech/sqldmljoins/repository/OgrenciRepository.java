...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_3 = "SELECT o.* FROM ogrenci as o LEFT JOIN islem as i ON o.ogrno=i.ogrno WHERE i.ogrno ISNULL;";
    @Query(value = QUESTION_3, nativeQuery = true)
    List<Ogrenci> findStudentsWithNoBook();

    //10A veya 10B sınıfındaki öğrencileri sınıf ve okuduğu kitap sayısını getirin.
    String QUESTION_4 = "SELECT o.sinif, count(i.islemno) FROM ogrenci as o INNER JOIN islem as i ON o.ogrno=i.ogrno WHERE sinif IN ('10A','10B') GROUP BY o.sinif;";
